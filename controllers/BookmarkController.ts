 ...
 *     </li>
 *     <li>GET /api/users/:uid/bookmarks retrieves a user's bookmark list
 * </ul>
...
export default class BookmarkController implements BookmarkControllerI {
    ...
    /**
     * @param {Request} req Represents request from client, including the
     * path parameters uid and tid representing the user that unbookmarks the tuit and
